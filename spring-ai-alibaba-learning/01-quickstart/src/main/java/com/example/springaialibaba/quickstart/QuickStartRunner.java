...
/**
 * ============================================================================
 * 第一个 Spring AI Alibaba 演示：调用通义千问并打印回答
 * ============================================================================
 *
 * 【核心流程图】
 *
 *   你的代码                ChatClient           通义千问(DashScope)
 *     │                        │                         │
 *     │  prompt().user("问题")  │                         │
 *     │ ─────────────────────► │                         │
 *     │                        │   HTTP 请求(带你的问题)   │
 ...
 *
 * 【重点】这套 ChatClient API 完全来自 Spring AI（org.springframework.ai.*）。
 *   Spring AI Alibaba 只是把“底层模型”换成了 DashScope，上层写法与 Spring AI 一模一样。
 *   所以学会这里，就同时会用两个框架的对话 API 了。
 * ============================================================================
 */
...
public class QuickStartRunner implements CommandLineRunner {
     ...
     *   —— 是 spring-ai-alibaba-starter-dashscope 自动配置出来的 Bean。
     *   它内部已经根据共享配置文件里的 api-key / model 配好了 DashScope 连接。
     *
    ...
    public void run(String... args) {
        ...
        // 我们要问大模型的问题
        String question = "请用一句话向 Java 初学者解释什么是 Spring AI Alibaba？";
